...
- What do the probe numbers mean? _Indication of hypermethylated sites_ 
- How can this be translated into assessing genome-wide methylation? _Compare the numbers to see if TET2 has a similar effect to IDH hypermethylation. Spoiler, it does not_
